...
public class ScoreManager : MonoBehaviour
{
    ...
    void ScaleText()
    {
        ...
        {
            currentScaleTween.Kill(complete:true);
        ...
        //var scaleSet = new Vector3TweenSetup(originalScale * amount,duraiton,Ease.Linear);
        // currentScaleTween = scoreText.gameObject.Scaler(scaleSet);
